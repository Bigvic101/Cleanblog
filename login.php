...
<?php
  ...
  include('functions/validatelogin.php');

  include('functions/stratlogin.php');
?>
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="page-heading">
            <h1>Login</h1>
            <span class="subheading">Your DevStory is unique</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <form method="POST" action"">
          ...
          <br>
          <div id="success"></div>
          <button type="submit" class="btn btn-success float-right" name="sendLoginButton">Login</button>
        </form>
      </div>
    </div>
  </div>
